...
module polar_universal::polar_identity {
    ...
    #[view]
    public fun get_ceo(): address acquires IdentityConfig {
        borrow_global<IdentityConfig>(@polar_universal).ceo
    }

    #[view]
    public fun get_total_registered(): u64 acquires IdentityConfig {
        borrow_global<IdentityConfig>(@polar_universal).total_registered
    }
